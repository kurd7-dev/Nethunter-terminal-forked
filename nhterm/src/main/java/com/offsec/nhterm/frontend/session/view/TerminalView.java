...
public final class TerminalView extends View {
                        ...
                        new GestureAndScaleRecognizer.Listener() {
                            ...
                            public boolean onUp(@NonNull MotionEvent e) {
                                ...
                                if (mEmulator != null
                                    ...
                                    sendMouseEventCode(
                                            e, TerminalEmulator.MOUSE_LEFT_BUTTON, false);
                                    return true;
                                }
                            ...
                            public boolean onScroll(
                                    @NonNull MotionEvent e, float distanceX, float distanceY) {
                            ...
                            public boolean onDoubleTap(@NonNull MotionEvent e) {
                                // Old behavior: Do not treat is as a single confirmed tap - it may
                                // be followed by zoom.

                                // For treating double tap as MOUSE_LEFT_BUTTON_MOVED event
                                // e.g in vim, we can change window size with fingers moving.
                                // Now double tap and drag has been treated as a
                                // MOUSE_LEFT_BUTTON_MOVED event.
                                return true;
                            }
                                ...
                                if (mEmulator.isMouseTrackingActive()
                                    ...
                                    switch (e.getAction()) {
                                        case MotionEvent.ACTION_DOWN:
                                            ...
                                            sendMouseEventCode(
                                                    e, TerminalEmulator.MOUSE_LEFT_BUTTON, true);
                                            break;
                                        ...
                                        case MotionEvent.ACTION_MOVE:
                                            if (Math.abs(e.getX() - doubleTapX)
                                                            >= mRenderer.mFontWidth
                                                    || Math.abs(e.getY() - doubleTapY)
    ...
    void sendMouseEventCode(MotionEvent e, int button, boolean pressed) {
        ...
        int y =
                (int)
                                ((e.getY() - mRenderer.mFontLineSpacingAndAscent)
                                        / mRenderer.mFontLineSpacing)
                        + 1;
        if (pressed
        ...
        if (mIsSelectingText) {
            if (mLeftSelectionHandle == null) {
                mLeftSelectionHandle =
                        (BitmapDrawable)
                                getContext()
                                        .getDrawable(R.drawable.text_select_handle_left_material);
                mRightSelectionHandle =
                        (BitmapDrawable)
                                getContext()
                                        .getDrawable(R.drawable.text_select_handle_right_material);
            }
            ...
            int cy =
                    (int) ((ev.getY() + SELECT_TEXT_OFFSET_Y) / mRenderer.mFontLineSpacing)
                            + mTopRow;
            ...
            if (!" ".equals(screen.getSelectedText(mSelX1, mSelY1, mSelX1, mSelY1))) {
                ...
                while (mSelX1 > 0
                        && !screen.getSelectedText(mSelX1 - 1, mSelY1, mSelX1 - 1, mSelY1)
                                .isEmpty()) {
                    mSelX1--;
                }
                while (mSelX2 < mEmulator.mColumns - 1
                        && !screen.getSelectedText(mSelX2 + 1, mSelY1, mSelX2 + 1, mSelY1)
                                .isEmpty()) {
                    mSelX2++;
                }
            }
                        ...
                        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                            ...
                            switch (item.getItemId()) {
                                case 1:
                                    String selectedText =
                                            mEmulator
                                                    .getSelectedText(mSelX1, mSelY1, mSelX2, mSelY2)
                                                    .trim();
                    ...
                    startActionMode(
                            new ActionMode.Callback2() {
                                ...
                                public void onGetContentRect(
                                        ActionMode mode, View view, Rect outRect) {
